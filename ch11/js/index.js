$(function() {
    ...
    $('.content').eq(1).hide();
    $('.content').eq(2).hide();
    $('.sport .fr > li').mouseenter(function() {
            // 导航激活类的切换
            $(this).addClass('active').siblings('li').removeClass('active')
                // 获取对应的索引
            var index = $(this).index();
            // 内容切换
            $('.sport .content').eq(index).show().siblings('.content').hide();
    ...
    /*童装列表切换*/
    $('.sport-content').eq(1).hide();
    $('.sport-content').eq(2).hide();
    $('.childrens .fr > li').mouseenter(function() {
            // 导航激活类的切换
            $(this).addClass('active').siblings('li').removeClass('active')
                // 获取对应的索引
            var index = $(this).index();
            // 内容切换
            $('.childrens .sport-content').eq(index).show().siblings('.sport-content').hide();
